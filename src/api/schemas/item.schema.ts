...
export type ItemCreateResponse = FastifyReply<{ Body: ItemPublic }>
export type ItemParamsRequest = FastifyRequest<{ Params: ItemParams }>
export type ItemGetByIdResponse = FastifyReply<{ Body: ItemPublic }>
export type ItemPatchByIdRequest = FastifyRequest<{ Body: ItemUpdate, Params: ItemParams }>
export type ItemPatchByIdResponse = FastifyReply<{ Body: ItemPublic }>
export type ItemDeleteByIdResponse = FastifyReply<{ Body: ItemPublic }>
